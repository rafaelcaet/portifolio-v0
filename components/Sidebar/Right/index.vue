    ...
    <SidebarRightPreviewCard title="What's happening">
      ...
      >
        <div>
          ...
          <p class="text-sx text-gray-400">{{ whatsHappening.count }}</p>
        </div>
      </SidebarRightPreviewCardItem>
...
const whatsHappeningItems = ref([
  { title: "Douglita", count: "58.5k Tweets" },
  { title: "Ricardin", count: "43.2k Tweets" },
  { title: "Fael", count: "8.5k Tweets" },
  { title: "ICelias", count: "12.1k Tweets" },
  { title: "Marcondes", count: "156.2k Tweets" },
]);
